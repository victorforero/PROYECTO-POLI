            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="licencia" class="col-md-4 col-form-label text-md-right">{{ __('Licencia') }}</label>

                            <div class="col-md-6">
                                <input id="licencia" type="number" class="form-control @error('licencia') is-invalid @enderror" name="licencia" value="{{ old('licencia') }}" required autocomplete="Licencia">
